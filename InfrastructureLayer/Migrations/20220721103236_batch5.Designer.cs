...
namespace InfrastructureLayer.Migrations
{
    ...
    [Migration("20220721103236_batch5")]
    partial class batch5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InfrastructureLayer.BuyingGroup", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.City", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.ColdRoomTemperature", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex(new[] { "ColdRoomSensorNumber" }, "IX_Warehouse_ColdRoomTemperatures_ColdRoomSensorNumber"), false);
            ...
            modelBuilder.Entity("InfrastructureLayer.Color", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.Country", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.Customer", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.CustomerCategory", b =>
                {
                    b.Property<int>("CustomerCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.CustomerTransaction", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.DeliveryMethod", b =>
                {
                    b.Property<int>("DeliveryMethodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.Invoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.InvoiceLine", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.OrderLine", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.PackageType", b =>
                {
                    b.Property<int>("PackageTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.PaymentMethod", b =>
                {
                    b.Property<int>("PaymentMethodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.Person", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.PurchaseOrder", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.PurchaseOrderLine", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.SpecialDeal", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.StateProvince", b =>
                {
                    b.Property<int>("StateProvinceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.StockGroup", b =>
                {
                    b.Property<int>("StockGroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.StockItem", b =>
                {
                    b.Property<int>("StockItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.StockItemHolding", b =>
                {
                    b.Property<int>("StockItemId")
                        .HasColumnType("int")
                        .HasColumnName("StockItemID");
            ...
            modelBuilder.Entity("InfrastructureLayer.StockItemStockGroup", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.StockItemTransaction", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.SupplierCategory", b =>
                {
                    b.Property<int>("SupplierCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.SupplierTransaction", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.SystemParameter", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.TransactionType", b =>
                {
                    b.Property<int>("TransactionTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfrastructureLayer.VehicleTemperature", b =>
                {
            ...
            modelBuilder.Entity("InfrastructureLayer.VehicleTemperature1", b =>
                {
                    b.Property<int>("ChillerSensorNumber")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InfrastructureLayer.BuyingGroup", b =>
                {
                    b.HasOne("InfrastructureLayer.Person", "LastEditedByNavigation")
            ...
            modelBuilder.Entity("InfrastructureLayer.City", b =>
                {
                    ...
                    b.HasOne("InfrastructureLayer.StateProvince", "StateProvince")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("InfrastructureLayer.Customer", b =>
                {
                    b.HasOne("InfrastructureLayer.Person", "AlternateContactPerson")
                    ...
                    b.HasOne("InfrastructureLayer.Customer", "BillToCustomer")
                    ...
                    b.HasOne("InfrastructureLayer.DeliveryMethod", "DeliveryMethod")
                        .WithMany("Customers")
                    ...
                    b.HasOne("InfrastructureLayer.City", "PostalCity")
                    ...
                    b.HasOne("InfrastructureLayer.Person", "PrimaryContactPerson")
            ...
            modelBuilder.Entity("InfrastructureLayer.CustomerTransaction", b =>
                {
                    ...
                    b.HasOne("InfrastructureLayer.PaymentMethod", "PaymentMethod")
                        .WithMany("CustomerTransactions")
                        .HasForeignKey("PaymentMethodId")
                        .HasConstraintName("FK_Sales_CustomerTransactions_PaymentMethodID_Application_PaymentMethods");

                    b.HasOne("InfrastructureLayer.TransactionType", "TransactionType")
                        .WithMany("CustomerTransactions")
            ...
            modelBuilder.Entity("InfrastructureLayer.Invoice", b =>
                {
                    b.HasOne("InfrastructureLayer.Person", "AccountsPerson")
                    ...
                    b.HasOne("InfrastructureLayer.Person", "ContactPerson")
                    ...
                    b.HasOne("InfrastructureLayer.Order", "Order")
                        .WithMany("Invoices")
                        .HasForeignKey("OrderId")
                        .HasConstraintName("FK_Sales_Invoices_OrderID_Sales_Orders");

                    b.HasOne("InfrastructureLayer.Person", "PackedByPerson")
                    ...
                    b.HasOne("InfrastructureLayer.Person", "SalespersonPerson")
            ...
            modelBuilder.Entity("InfrastructureLayer.InvoiceLine", b =>
                {
                    ...
                    b.HasOne("InfrastructureLayer.PackageType", "PackageType")
                        .WithMany("InvoiceLines")
                        .HasForeignKey("PackageTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_Sales_InvoiceLines_PackageTypeID_Warehouse_PackageTypes");

                    b.HasOne("InfrastructureLayer.StockItem", "StockItem")
                        .WithMany("InvoiceLines")
            ...
            modelBuilder.Entity("InfrastructureLayer.Order", b =>
                {
                    b.HasOne("InfrastructureLayer.Order", "BackorderOrder")
                    ...
                    b.HasOne("InfrastructureLayer.Person", "PickedByPerson")
            ...
            modelBuilder.Entity("InfrastructureLayer.PurchaseOrder", b =>
                {
                    ...
                    b.HasOne("InfrastructureLayer.Supplier", "Supplier")
                        .WithMany("PurchaseOrders")
            ...
            modelBuilder.Entity("InfrastructureLayer.PurchaseOrderLine", b =>
                {
                    ...
                    b.HasOne("InfrastructureLayer.PurchaseOrder", "PurchaseOrder")
                        .WithMany("PurchaseOrderLines")
            ...
            modelBuilder.Entity("InfrastructureLayer.SpecialDeal", b =>
                {
                    ...
                    b.HasOne("InfrastructureLayer.StockGroup", "StockGroup")
                        .WithMany("SpecialDeals")
            ...
            modelBuilder.Entity("InfrastructureLayer.StateProvince", b =>
                {
                    b.HasOne("InfrastructureLayer.Country", "Country")
            ...
            modelBuilder.Entity("InfrastructureLayer.StockItem", b =>
                {
                    b.HasOne("InfrastructureLayer.Color", "Color")
                        .WithMany("StockItems")
                    ...
                    b.HasOne("InfrastructureLayer.PackageType", "OuterPackage")
                    ...
                    b.HasOne("InfrastructureLayer.PackageType", "UnitPackage")
            ...
            modelBuilder.Entity("InfrastructureLayer.StockItemHolding", b =>
                {
                    ...
                    b.HasOne("InfrastructureLayer.StockItem", "StockItem")
                        ...
                        .HasForeignKey("InfrastructureLayer.StockItemHolding", "StockItemId")
                        .IsRequired()
            ...
            modelBuilder.Entity("InfrastructureLayer.Supplier", b =>
                {
                    ...
                    b.HasOne("InfrastructureLayer.SupplierCategory", "SupplierCategory")
                        .WithMany("Suppliers")
